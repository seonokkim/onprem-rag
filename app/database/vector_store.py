...
class VectorStore:
    ...
    def __init__(self):
        ...
        self.llm_factory = LLMFactory("embedding_model")

    def get_embedding(self, text: str) -> List[float]:
        """
        Generate embedding for the given text using the configured local model.
        ...
        embedding = (
            self.llm_factory.client.embeddings.create(
                input=[text],
                model=self.settings.embedding_model.default_model,
            )
            .data[0]
            .embedding
        )
